...
OPERATOR_IMAGE=$(REGISTRY)/tec-operator:v$(VERSION)
COMPUTE_PCRS_IMAGE=$(REGISTRY)/tec-compute-pcrs:v$(VERSION)
REG_SERVER_IMAGE=$(REGISTRY)/tec-register-server:v$(VERSION)
