...
push: image
	$(CONTAINER_CLI) push $(OPERATOR_IMAGE) $(TLS_VERIFY_FLAG)
	$(CONTAINER_CLI) push $(COMPUTE_PCRS_IMAGE) $(TLS_VERIFY_FLAG)
	$(CONTAINER_CLI) push $(REG_SERVER_IMAGE) $(TLS_VERIFY_FLAG)
